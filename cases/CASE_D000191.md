...
**Created:** 2026-07-05T16:48:56.227627+00:00  
...
|---|------|------------|----------------|----------------------------------------|-----------|------------|
| 1 | Identity document authenticity | identity_vendor | Pull latest verification event from fact_driver_identity_verification for D000191 | [SIMULATED] **MISMATCH** — Document OCR confidence below threshold or face-match score < 0.85 | HIGH | ⚠️ YES |
| 2 | Device risk intelligence | device_intel | Submit device_id D000191... to device risk API | [SIMULATED] **FLAGGED** — Device fingerprint matches known GPS spoofing tool signature | HIGH | ⚠️ YES |
...
**Evidence integrity SHA-256:** `639f039fafa606bc6749283f74546e8e98c1373bf8291345fd84b888ea7c1cc6`
