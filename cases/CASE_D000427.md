...
**Created:** 2026-07-05T16:43:35.059656+00:00  
...
|---|------|------------|----------------|----------------------------------------|-----------|------------|
| 1 | Identity document authenticity | identity_vendor | Pull latest verification event from fact_driver_identity_verification for D000427 | [SIMULATED] **MISMATCH** — Document OCR confidence below threshold or face-match score < 0.85 | HIGH | ⚠️ YES |
| 2 | Device risk intelligence | device_intel | Submit device_id D000427... to device risk API | [SIMULATED] **CLEAN** — No known fraud tool signatures detected on device profile | MEDIUM | ✓ NO |
...
**Evidence integrity SHA-256:** `e27dec29c3406ec132101fe010323d73fd399a2eeee504b3288c5bd8e9bb54eb`
