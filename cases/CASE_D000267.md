...
**Created:** 2026-07-05T17:02:53.006617+00:00  
...
|---|------|------------|----------------|----------------------------------------|-----------|------------|
| 1 | Identity document authenticity | identity_vendor | Pull latest verification event from fact_driver_identity_verification for D000267 | [SIMULATED] **MATCH** — Document verified, face-match score ≥ 0.92 | HIGH | ✓ NO |
| 2 | Device risk intelligence | device_intel | Submit device_id D000267... to device risk API | [SIMULATED] **CLEAN** — No known fraud tool signatures detected on device profile | MEDIUM | ✓ NO |
...
**Evidence integrity SHA-256:** `de20f2107e06dda06b6436acd5c313bfecd05224d4fc7ec7fb9fa7bf20b7bdb9`
