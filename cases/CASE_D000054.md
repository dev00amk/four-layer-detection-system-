...
**Created:** 2026-07-05T16:43:35.079415+00:00  
...
|---|------|------------|----------------|----------------------------------------|-----------|------------|
| 1 | Identity document authenticity | identity_vendor | Pull latest verification event from fact_driver_identity_verification for D000054 | [SIMULATED] **MISMATCH** — Document OCR confidence below threshold or face-match score < 0.85 | HIGH | ⚠️ YES |
| 2 | Device risk intelligence | device_intel | Submit device_id D000054... to device risk API | [SIMULATED] **CLEAN** — No known fraud tool signatures detected on device profile | MEDIUM | ✓ NO |
...
**Evidence integrity SHA-256:** `e4b05f39a3d31f40ad3324c1afe5bd4902b7b20168d70228541eb04cdece8ce6`
