...
def get_mock_trips_df():
    trips_data = [
        ...
        # 3. D_LEGIT_FAMILY_SEQUENTIAL: spouses share family tablet sequentially (A -> B -> A)
        ...
        # 5. D_COLLISION_UNCORROBORATED: overlapping trips (>10km apart) on same device (DEV_COLL) but no payout link/change
        ...
        # 7. D_TIER2_HIGH_RISK: device shared by 3 drivers, has rooted flag. Driver D_T2_A has payout change
        {"driver_id": "D_T2_A", "trip_id": "T15", "trip_start_ts": "2026-07-05 12:00:00", "trip_end_ts": "2026-07-05 12:30:00",
         "pickup_lat": 40.7128, "pickup_lon": -74.0060, "device_id": "DEV_T2", "payout_account": "BANK_T2_A", "payout_change_72h": 1, "emulator_flag": 0, "rooted_device_flag": 1},
        {"driver_id": "D_T2_B", "trip_id": "T16", "trip_start_ts": "2026-07-05 13:00:00", "trip_end_ts": "2026-07-05 13:30:00",
         "pickup_lat": 40.7128, "pickup_lon": -74.0060, "device_id": "DEV_T2", "payout_account": "BANK_T2_B", "payout_change_72h": 0, "emulator_flag": 0, "rooted_device_flag": 1},
        {"driver_id": "D_T2_C", "trip_id": "T17", "trip_start_ts": "2026-07-05 14:00:00", "trip_end_ts": "2026-07-05 14:30:00",
         "pickup_lat": 40.7128, "pickup_lon": -74.0060, "device_id": "DEV_T2", "payout_account": "BANK_T2_C", "payout_change_72h": 0, "emulator_flag": 0, "rooted_device_flag": 1},
        ...
        # 9. D_BYSTANDER: bystander who has payout change on clean shared device DEV_FAM (sequential sharing, no rooted/emulator)
        {"driver_id": "D_BYSTANDER", "trip_id": "T20", "trip_start_ts": "2026-07-05 15:00:00", "trip_end_ts": "2026-07-05 15:30:00",
         "pickup_lat": 40.7128, "pickup_lon": -74.0060, "device_id": "DEV_FAM", "payout_account": "BANK_BYSTANDER", "payout_change_72h": 1, "emulator_flag": 0, "rooted_device_flag": 0}
    ]
...
def test_tier2_high_risk_device_with_payout_change():
    df = get_mock_trips_df()
    triggered = run_duckdb_signal(df)
    assert "D_T2_A" in triggered
    # D_T2_B and D_T2_C have no payout change, so they don't trigger
    assert "D_T2_B" not in triggered
    assert "D_T2_C" not in triggered
